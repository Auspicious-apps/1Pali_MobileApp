      ...
      <SafeAreaView style={styles.safeArea} edges={["top"]}>
        ...
        >
          ...
          <Bullet>
            ...
            based, in this case is US
          </Bullet>
          <Bullet>
            Customer: refers to the company, organization or person that signs
            up to use the One Pali Service to manage the relationships with your
          ...
          <Bullet>
            Personnel: refers to those individuals who are employed by One Pali
          ...
          <Bullet>
            Service: refers to the service provided by One Pali as described in
          ...
          <Bullet>
            You: a person or entity that is registered with One Pali to use the
            Services.
          </Bullet>
          ...
          <Bullet>
            Phonebook (Contacts list): Your contacts list allows the platform to
            be much more easy to use by the user, since accessing your contacts
            from the app makes you save tons of time.
          </Bullet>

          <Title>
            When does One Pali use end user information from third parties?
          </Title>
          <Text>
            One Pali will collect End User Data necessary to provide the One
            Pali services to our customers. End users may voluntarily provide us
            with information they have made available on social media websites.
            If you provide us with any such information, we may collect publicly
          ...
          <Title>
            When does One Pali use customer information from third parties?
          </Title>
          <Text>
            ...
            interest in becoming a One Pali customer, we receive information
            from a third party that provides automated fraud detection services
            to One Pali. We also occasionally collect information that is made
          ...
          <Text>
            ...
            services you may purchase through the app. We will likely share your
          ...
          <Text>
            ...
            visit the app. They may aggregate information about our advertising
            and what you see on the app and then provide auditing, research and
          ...
          <Text>
            One Pali will collect personal information that you submit to us. We
            may also receive personal information about you from third parties
            as described above.
          </Text>
          ...
          <Bullet>To process transactions</Bullet>
          <Bullet>
            To administer a contest, promotion, survey or other site feature
          </Bullet>
          <Bullet>To send periodic emails</Bullet>
          ...
          <Text>
            ...
            submitted only through the order processing page will be used for
            the sole purpose of sending you information and updates pertaining
            to your order. If, however, you have provided the same email to us
            through another method, we may use it for any of the purposes stated
            in this Policy. Note: If at any time you would like to unsubscribe
          ...
          <Text>
            We keep your information only so long as we need it to provide One
            Pali to you and fulfill the purposes described in this policy. This
          ...
          <Text>
            ...
            information you transmit to One Pali or guarantee that your
          ...
          <Title>Could my information be transferred to other countries?</Title>
          <Text>
            One Pali is incorporated in US. Information collected via our app,
            ...
            that may not have laws of general applicability regulating the use
            and transfer of such data. To the fullest extent allowed by
          ...
          <Title>
            Is the information collected through the One Pali Service secure?
          </Title>
          <Text>
          ...
          <Title>Can I update or correct my information?</Title>
          <Text>
            The rights you have to request updates or corrections to the
            information One Pali collects depend on your relationship with One
            Pali. Personnel may update or correct their information as detailed
          ...
          <Text>
            ...
            identifiable information, (2) change your preferences with respect
            to communications and other information you receive from us, or (3)
          ...
          <Text>
            If you are a One Pali worker or applicant, we collect information
          ...
          <Text>
            ...
            all of the assets of One Pali or any of its Corporate Affiliates (as
            defined herein), or that portion of One Pali or any of its Corporate
          ...
          <Text>
            ...
            control with One Pali, whether by ownership or otherwise. Any
          ...
          <Text>
            This Privacy Policy is governed by the laws of US without regard to
          ...
          <Text>
            The laws of US, excluding its conflicts of law rules, shall govern
          ...
          <Text>
            By using One Pali or contacting us directly, you signify your
            ...
            services. Continued use of the app, direct engagement with us, or
          ...
          <Text>
            ...
            it's being used. By using our One Pali, registering an account, or
            making a purchase, you hereby consent to our Privacy Policy and
            agree to its terms.
          </Text>
          ...
          <Text>
            ...
            contain links to other websites not operated or controlled by One
            Pali. We are not responsible for the content, accuracy or opinions
            ...
            website, our Privacy Policy is no longer in effect. Your browsing
          ...
          <Title>Blocking and disabling cookies and similar technologies</Title>
          <Text>
            ...
            essential cookies and prevent our app from functioning properly, and
            you may not be able to fully utilize all of its features and
          ...
          <Text>
            ...
            Service, you will be bound by the updated Privacy Policy. If you do
            not want to agree to this or any updated Privacy Policy, you can
            delete your account.
          </Text>
          ...
          <Text>
            ...
            people take on your website/app. You can use the pixel to: Make sure
          ...
          <Text>
            ...
            Device for security purposes. Google Maps API collects information
          ...
          <Text>
            ...
            the right thing to do. At One Pali we strongly believe that your
            data privacy is very important and we already have solid security
            and privacy practices in place that go beyond the requirements of
            this new regulation.
          </Text>
          ...
          <Text>
            ...
            rights requirements of GDPR. One Pali processes or stores all
          ...
          <Title>California Online Privacy Protection Act (CalOPPA)</Title>
          <Text>
